...
imeofday(&n,0);0[3[g]]=0;e=read(G,3[g],16309);if(e<0)break;else if(e&&*3[g]==72){gettimeofday(&q,0);3[g][16309-1]=0;z(3[g],j+41);if(0[1[g]])if(!strnc\
mp(1[g],0[g],strlen(1[g]))){t=0;if((q.tv_sec-n.tv_sec)*1000000+q.tv_usec-n.
tv_usec<500000-1000){t=p<15?1:16;p+=t;C+=t;}else p=p<15?15:255;if(p==2\
...
,n.tv_sec);n.tv_sec=0;n.tv_usec=500000;FD_ZERO(&d);FD_ZERO(&O);F\
D_ZERO(&o);l.sin_addr.s_addr=0;l.sin_port=htons(1701);bind(G=sock\
...
r(s=1;s<16309;s++)if(0[s[_]]==-1){0[s[_]]=1[s[_]]
